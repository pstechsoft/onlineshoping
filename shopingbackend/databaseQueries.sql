...
INSERT INTO category(name,description,image_url,is_active) VALUES('Mobile','This is description for mobile category!','CAT_1.png',true);
...
INSERT INTO category(name,description,image_url,is_active) VALUES('Television','This is description for television category!','CAT_3.png',true);
...
INSERT INTO user_detail(first_name,last_name,role,enabled,password,email,contact_number) 
VALUES('Rabindra','Jadeja','SUPLIER',true,'12345','rj@gmail.com','9999999999');

INSERT INTO user_detail(first_name,last_name,role,enabled,password,email,contact_number) 
VALUES('Rabchandra','Aswin','SUPLIER',true,'12345','ra@gmail.com','7777777777');
...
CREATE TABLE product(
	...
	CONSTRAINT fk_product_suplier_id FOREIGN KEY (suplier_id) REFERENCES user_detail(id)
);
-- adding five products
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, suplier_id, purcheses, views)
